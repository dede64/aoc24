        ...
        for frequency in frequencies {
            ...
            for i in 0..<frequencyaAntenas.count {
                for j in i+1..<frequencyaAntenas.count {
                    ...
                    let antinodeLocation1 = Location(x: antenna1.location.x - difX, y: antenna1.location.y - difY)
                    let antinodeLocation2 = Location(x: antenna2.location.x + difX, y: antenna2.location.y + difY)
                    
                    if locationIsValid(antinodeLocation1, width: width, height: height) {
                        antinodes.insert(antinodeLocation1)
                    }
                    
                    if locationIsValid(antinodeLocation2, width: width, height: height) {
                        antinodes.insert(antinodeLocation2)
                    }
                }
            }
        }
